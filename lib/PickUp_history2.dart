...
class PickupHistory2 extends StatefulWidget {
  const PickupHistory2({Key key}) : super(key: key);

  @override
  _PickupHistory2State createState() => _PickupHistory2State();
}

class _PickupHistory2State extends State<PickupHistory2> {
  List data = [];
  ...
  getData() async {
    ...
    Uri url = Uri.parse(
        "${server.serverurl}pickup_history?secretkey=ADMIN&secretpass=ADMIN&user_id=$userId");
